...
function MusicZoneHeader({
  ...
  function onClickPlay() {
    selectPlayingMusic(musicZoneData.id, 0);
  }
    ...
    <div className="flex-1">
      <div className="flex sticky top-[50%] translate-y-[-50%] flex-col items-center flex-1 gap-2">
        ...
        <div className="w-full flex flex-col items-center gap-1">
          ...
          <h1 className="text-xl font-bold ">{musicZoneData.zone_name}</h1>
          <p className="text-text-tertiary text-xs">
            {musicZoneData.created_at.slice(0, 10)} {musicZoneData.description}{" "}
            {trackLength}곡 수록
          </p>
        </div>
